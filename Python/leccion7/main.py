...
person = ["Federico", "Pfund"]

show(person[0], person[1])# Pasamos uno por uno los datos de la lista a la función
show(*person) # Esto es lo mismo que lo anterior pero le pasamos todo junto
person2 = ("Carlitos", "Spedaletti") # desempaquetamos a través de una tupla
show(*person2)
person3 = {"lastName": "beto", "name": "juan"}
show(**person3)
...
names = ["Paolo", "rodrigo", "Pupe", "repe"]
alongP = [p for p in names if p[0] == 'P'] # Esto regresa una nueva lista
print(alongP)

botellaCerveza = [{"name": "Quilmes", "country": "Arg"},
           {"name": "Corona", "country": "Mx"},
           {"name": "Stella Artois", "country": "Belgium"},
           ]
Arg = [b for b in botellaCerveza if b["country"] == "Arg"] # Interpretacion de lista
print(Arg)
print(botellaCerveza)
