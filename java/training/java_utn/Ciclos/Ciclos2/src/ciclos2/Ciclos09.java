/*
Ejercicio 9: 
            Pedir el dia mes, mes y año de una fecha e indicar si la fecha es correcta
...
public class Ciclos09 {
    public static void main(String[] args) {
        ...
        System.out.println("Digite el añio: ");
        ...
        }else{System.out.println("Fecha incorrecta, dia incorrecto");}
    }   
}
